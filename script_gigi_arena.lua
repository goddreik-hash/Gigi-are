...
local Workspace         = game:GetService("Workspace"Gigi arena"PlayerGui")
...
local CFG = {
	...
	HarpoonColor   = Color3.fromRGB(200, 0, 255),
	GlowColor      = Color3.fromRGB(200, 0, 255),
	PriorityList   = { "Magmew", "Meta"Gigi arena"—",
	inRangeCount = 0,
	debugText    = "Waiting...",
	wallAvoidMsg = "",
}
...
--  HIGHLIGHT
-- ══════════════════════════════════════════════
local selBox = Instance.new("SelectionBox"Gigi arena"WhatIfArenaUI")
	if old then old:Destroy() end

	local sg = Instance.new("Gigi arena")
	sg.Name="WhatIfArenaUI"Gigi arena"Frame")
	Panel.Name="Panel"; Panel.Size=UDim2.new(0,320,0,540)
	Panel.Position=UDim2.new(0,30,0.15,0); Panel.BackgroundColor3=Color3.fromRGB(200, 0, 255)
	...
	_.Color=Color3.fromRGB(200, 0, 255); _.Thickness=2; _.Transparency=0.3; _.Parent=Panel
	...
	Hdr.BackgroundColor3=Color3.fromRGB(200, 0, 255); Hdr.BorderSizePixel=0; Hdr.ZIndex=2; Hdr.Parent=Panel
	...
	hFix.BackgroundColor3=Color3.fromRGB(200, 0, 255); hFix.BorderSizePixel=0; hFix.ZIndex=2; hFix.Parent=Hdr
	...
	ttl.Font=Enum.Font.GothamBold; ttl.TextSize=16; ttl.TextColor3=Color3.fromRGB(200, 0, 255)
	ttl.TextXAlignment=Enum.TextXAlignment.Left; ttl.ZIndex=3; ttl.Parent=Hdr
	ttl.TextStrokeTransparency = 0.5
	ttl.TextStrokeColor3 = Color3.fromRGB(200, 0, 255)
	
	-- Minimize button
	local MinBtn=Instance.new("TextButton"); MinBtn.Size=UDim2.new(0,32,0,32)
	MinBtn.Position=UDim2.new(1,-40,0.5,-16); MinBtn.BackgroundColor3=Color3.fromRGB(200, 0, 255)
	MinBtn.Text="−"; MinBtn.Font=Enum.Font.GothamBold; MinBtn.TextSize=20
	MinBtn.TextColor3=Color3.fromRGB(200, 0, 255); MinBtn.BorderSizePixel=0; MinBtn.ZIndex=4; MinBtn.Parent=Hdr
	local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(1,0); _.Parent=MinBtn
	local _=Instance.new("UIStroke"); _.Color=Color3.fromRGB(200, 0, 255); _.Thickness=1.5; _.Transparency=0.5; _.Parent=MinBtn
	...
	Con.ScrollBarImageColor3=Color3.fromRGB(200, 0, 255); Con.CanvasSize=UDim2.new(0,0,0,0)
	...
	local function sLbl(txt, order)
		...
		l.Text=txt; l.Font=Enum.Font.GothamBold; l.TextSize=12; l.TextColor3=Color3.fromRGB(200, 0, 255)
	...
	local function div(order)
		...
		d.BackgroundColor3=Color3.fromRGB(200, 0, 255); d.BorderSizePixel=0
	...
	local function sRow(lt, dv, order)
		...
		l.Text=lt; l.Font=Enum.Font.Gotham; l.TextSize=12; l.TextColor3=Color3.fromRGB(200, 0, 255)
		...
		v.TextColor3=Color3.fromRGB(200, 0, 255); v.TextXAlignment=Enum.TextXAlignment.Right; v.ZIndex=2; v.Parent=r
		return v
	end
	
	local function tRow(lt, def, order, cb)
		local row=Instance.new("Frame"); row.Size=UDim2.new(1,0,0,40)
		row.BackgroundColor3=Color3.fromRGB(200, 0, 255); row.BorderSizePixel=0; row.LayoutOrder=order; row.ZIndex=2; row.Parent=Con
		local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,10); _.Parent=row
		local _=Instance.new("UIStroke"); _.Color=Color3.fromRGB(200, 0, 255); _.Thickness=1; _.Transparency=0.7; _.Parent=row
		...
		lbl.TextColor3=Color3.fromRGB(200, 0, 255); lbl.TextXAlignment=Enum.TextXAlignment.Left; lbl.ZIndex=3; lbl.Parent=row
		
		local pill=Instance.new("Frame"); pill.Size=UDim2.new(0,50,0,24); pill.Position=UDim2.new(1,-60,0.5,-12)
		pill.BackgroundColor3=def and Color3.fromRGB(200, 0, 255) or Color3.fromRGB(200, 0, 255)
		...
		knob.BackgroundColor3=Color3.fromRGB(200, 0, 255); knob.BorderSizePixel=0; knob.ZIndex=4; knob.Parent=pill
		...
		btn.MouseButton1Click:Connect(function()
			...
			TweenService:Create(pill,TweenInfo.new(0.2,Enum.EasingStyle.Quad),
				{BackgroundColor3=isOn and Color3.fromRGB(200, 0, 255) or Color3.fromRGB(200, 0, 255)}):Play()
	...
	vBypass.TextColor3=Color3.fromRGB(200, 0, 255)
	if ServerType=="MAIN"  then vServer.TextColor3=Color3.fromRGB(200, 0, 255) end
	if ServerType=="ARENA" then vServer.TextColor3=Color3.fromRGB(200, 0, 255) end
	div(3)
	...
	vDebug.TextSize=10; vDebug.TextColor3=Color3.fromRGB(200, 0, 255)
	...
	tRow("🛡️ AC Bypass", true, 28, function(on)
		...
		vBypass.TextColor3=on and Color3.fromRGB(200, 0, 255) or Color3.fromRGB(200, 0, 255)
	end)

	-- minimize / drag
	local minimized=false
	MinBtn.MouseButton1Click:Connect(function()
		minimized=not minimized; MinBtn.Text=minimized and "+" or "−"Gigi arena"Frame")
	FlyBtn.Name = "FlyFloatBtn"
	FlyBtn.Size = UDim2.new(0, 110, 0, 56)
	FlyBtn.Position = UDim2.new(0, 360, 0.15, 0)
	FlyBtn.BackgroundColor3 = Color3.fromRGB(200, 0, 255)
	FlyBtn.BorderSizePixel = 0
	FlyBtn.ZIndex = 10
	FlyBtn.Parent = sg
	local _=Instance.new("UICorner"); _.CornerRadius=UDim.new(0,14); _.Parent=FlyBtn
	local _=Instance.new("UIStroke"); _.Color=Color3.fromRGB(200, 0, 255); _.Thickness=2; _.Transparency=0.3; _.Parent=FlyBtn

	local flyPill = Instance.new("Frame")
	flyPill.Size = UDim2.new(0,50,0,24)
	flyPill.Position = UDim2.new(0.5,-25,1,-30)
	flyPill.BackgroundColor3 = Color3.fromRGB(200, 0, 255)
	...
	flyKnob.BackgroundColor3 = Color3.fromRGB(200, 0, 255)
	...
	flyLabel.TextColor3 = Color3.fromRGB(200, 0, 255)
	...
	flyStatusLbl.TextColor3 = Color3.fromRGB(200, 0, 255)
	...
	flyClickBtn.MouseButton1Click:Connect(function()
		...
		TweenService:Create(flyPill, TweenInfo.new(0.2, Enum.EasingStyle.Quad),
			{BackgroundColor3 = flyIsOn and Color3.fromRGB(200, 0, 255) or Color3.fromRGB(200, 0, 255)}):Play()
	...
	task.spawn(function()
		while true do
			...
			if FlyState.active then
				flyStatusLbl.Text="✈️ FLYING (1300)"; flyStatusLbl.TextColor3=Color3.fromRGB(200, 0, 255)
			elseif FlyState.enabled then
				flyStatusLbl.Text="Watching..."; flyStatusLbl.TextColor3=Color3.fromRGB(200, 0, 255)
			else
				flyStatusLbl.Text="DISABLED"; flyStatusLbl.TextColor3=Color3.fromRGB(200, 0, 255)
			end
...
RunService.Heartbeat:Connect(function(dt)
	...
	if State.nearest then
		...
		Display.nearest.TextColor3 = Color3.fromRGB(200, 0, 255)
		Display.dist.Text          = string.format("%.1f", State.nearestDist).." st"
		Display.dist.TextColor3    = Color3.fromRGB(200, 0, 255)
	else
